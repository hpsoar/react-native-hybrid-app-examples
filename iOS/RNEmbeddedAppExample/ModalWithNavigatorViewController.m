...
- (void)viewDidLoad {
    ...
    RCTRootView *rootView = [[RCTRootView alloc] initWithBridge:[cyRCT sharedManager].bridge moduleName:@"ModalWithNavigator" initialProperties:nil];
    ...
    [(ModalWithNavigatorCoordinator *)[[cyRCT sharedManager] nativeModuleForString:@"ModalWithNavigatorCoordinator"] setDelegate:self];
